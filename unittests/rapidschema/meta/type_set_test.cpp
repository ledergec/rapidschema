...
static_assert(TypeSet<int, float, double, nullptr_t>::Unique(), "Only unique types contained");

static_assert(TypeSet<int, float, double, nullptr_t>::Contains<double>(), "double is contained");

static_assert(TypeSet<int, float, double, nullptr_t>::Contains<int64_t>() == false, "int64_t is not contained");
