#!/bin/sh
################################################################################
# Title         : uploadDocumentation.sh
# Date created  : 2017
# Notes         : original script from Jeroen de Bruijn
__AUTHOR__="Christian Ledergerber"
# Preconditions:
...
#
# This script will upload Doxygen documentation and push the documentation to
...
DOXY_DOCUMENTATION=$TRAVIS_BUILD_DIR/build/include/doc/html/
...
# cp $TRAVIS_BUILD_DIR/doc/DoxygenLayout.xml . # we do not yet have a layout file
...
################################################################################
##### Copy the doxygen documentation to the current repo                   #####
cp -r ${DOXY_DOCUMENTATION} .
